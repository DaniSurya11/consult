          ...
          <form className="space-y-5">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="relative">
                  ...
                  <label htmlFor="client" className="flex flex-col items-center justify-center p-4 bg-slate-50 border-2 border-slate-100 rounded-2xl cursor-pointer peer-checked:border-[#1D64FB] peer-checked:bg-blue-50/50 transition-all duration-300">
                ...
                <div className="relative">
                  ...
                  <label htmlFor="lawyer" className="flex flex-col items-center justify-center p-4 bg-slate-50 border-2 border-slate-100 rounded-2xl cursor-pointer peer-checked:border-[#1D64FB] peer-checked:bg-blue-50/50 transition-all duration-300">
                    <div className="w-8 h-8 rounded-full bg-white shadow-sm flex items-center justify-center mb-2">
            ...
            >
              <div className="space-y-2">
                ...
                <input type="text" placeholder="Budi" className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl text-[14px] focus:outline-none focus:ring-2 focus:ring-[#1D64FB]/20 focus:border-[#1D64FB] transition" />
              </div>
              <div className="space-y-2">
                <label className="text-[13px] font-bold text-slate-700 uppercase tracking-wider">Nama Belakang</label>
                <input type="text" placeholder="Santoso" className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl text-[14px] focus:outline-none focus:ring-2 focus:ring-[#1D64FB]/20 focus:border-[#1D64FB] transition" />
              </div>
            </motion.div>
            ...
            >
              ...
              <input type="email" placeholder="nama@email.com" className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl text-[14px] focus:outline-none focus:ring-2 focus:ring-[#1D64FB]/20 focus:border-[#1D64FB] transition" />
            </motion.div>
            ...
            >
              ...
              <input type="password" placeholder="••••••••" className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl text-[14px] focus:outline-none focus:ring-2 focus:ring-[#1D64FB]/20 focus:border-[#1D64FB] transition" />
            </motion.div>
