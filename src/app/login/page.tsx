...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 font-sans p-4 md:p-10 flex items-center justify-center">
      <div className="bg-white rounded-[3rem] shadow-sm w-full max-w-[1100px] overflow-hidden grid md:grid-cols-2 min-h-[600px]">
        ...
        <div className="p-8 md:p-16 flex flex-col justify-center">
          ...
          <div className="mt-8">
            <button className="w-full flex items-center justify-center gap-3 py-4 border border-slate-200 rounded-2xl hover:bg-slate-50 transition font-semibold text-[14px]">
